...
import {
  ...
  useLayoutEffect2,
  useSize
} from "./chunk-K3E55JDS.js";
import {
  require_react_dom
} from "./chunk-S2PIVW3B.js";
import {
  createSlottable,
  useComposedRefs
} from "./chunk-R5HTSLI2.js";
import {
  require_jsx_runtime
} from "./chunk-CDVWIJSI.js";
import {
  require_react
} from "./chunk-SCRGCHWI.js";
import {
  __toESM,
  require_dist,
  require_dist2,
  require_dist3
} from "./chunk-NS4ASZ7Z.js";
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React11.useRef(true);
  const isPointerInTransitRef = React11.useRef(false);
  ...
  return (0, import_jsx_runtime6.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React11.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React11.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React11.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React11.useRef(false);
  ...
  const stateAttribute = React11.useMemo(() => {
  ...
  return (0, import_jsx_runtime6.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime6.jsx)(
    TooltipContextProvider,
    {
      ...
      onTriggerEnter: React11.useCallback(() => {
...
var TooltipTrigger = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    const handlePointerUp = React11.useCallback(() => isPointerDownRef.current = false, []);
    React11.useEffect(() => {
...
var TooltipContentHoverable = React11.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME2, props.__scopeTooltip);
  const ref = React11.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React11.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React11.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React11.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React11.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
